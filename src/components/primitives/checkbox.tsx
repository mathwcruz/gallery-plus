...
export const checkboxVariants = tv({
  ...
  variants: {
    variant: {
      default:
        'border-2 border-solid border-border-primary hover:border-border-active checked:border-accent-brand checked:bg-accent-brand group-hover:checked:border-accent-brand-light group-hover:bg-accent-brand-light',
    },
    size: {
